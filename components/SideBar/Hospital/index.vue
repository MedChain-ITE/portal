...
const menuItems = [
  ...
  //   label: 'Request Loans',
  //   children: [
  //     { icon: Collection, label: 'Request Loan', to: '/admin/request-loan/active' },
  //     { icon: Notebook, label: 'History', to: '/admin/request-loan/history' }
  //   ]
  // },
  // {
  //   icon: Wallet,
  //   label: 'Loans',
  //   children: [
  //     { icon: View, label: 'Active Loans', to: '/admin/loans/active' },
  //     { icon: Document, label: 'Loans History', to: '/admin/loans/history' }
  //   ]
  // },
  ...
  >
    ...
    <div class="flex items-center justify-between p-4 border-b border-gray-100 bg-white/50 backdrop-blur-sm">
      <transition name="slide-fade" mode="out-in">
        ...
        >
          MedChain
          <span class="block text-xs font-normal text-gray-500">Medical Record Chain</span>
        </h1>
      </transition>
      <el-button
        :icon="Menu"
